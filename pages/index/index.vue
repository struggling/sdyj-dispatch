	...
	<view>
		<view class="content">
								...
								<view class="orderlist">
									<view class="order-item">
										<view class="item-l">
											...
											<view class="distance">距离：&lt {{item.distance}}公里</view> <view class="tool"><span>毛巾</span><span>扳手大锤</span><span>长托帕</span></view>
			...
			<u-popup v-model="showpopup" mode="center" border-radius="8" width="80%" ref="popup"> 
						<view>
							<view class="iconfont iconclose" style="text-align: right;font-size: 40upx;color: #CCCCCC;padding-right: 20upx;padding-top: 20upx;" @tap="close"></view>
